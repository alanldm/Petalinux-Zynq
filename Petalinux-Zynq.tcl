...
#
# Petalinux-Zynq.tcl: Tcl script for re-creating project 'Petalinux-Zynq'
#
# Generated by Vivado on Wed May 28 09:46:52 +0200 2025
...
#
# 1. This project restoration tcl script (Petalinux-Zynq.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/lima/Desktop/Petalinux-Zynq/Petalinux-Zynq.srcs/sources_1/bd/Zynq/hdl/Zynq_wrapper.vhd"
#
...
set _xil_proj_name_ "Petalinux-Zynq"
...
set script_file "Petalinux-Zynq.tcl"
...
set files [list \
 [file normalize "${origin_dir}/Petalinux-Zynq.srcs/sources_1/bd/Zynq/hdl/Zynq_wrapper.vhd" ]\
]
...
proc cr_bd_Zynq { parentCell } {
  ...
  set pl_leds_2bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pl_leds_2bits ]

  set pl_pbs_2bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pl_pbs_2bits ]
  ...
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {pl_leds_2bits} \
  ...
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {pl_pbs_2bits} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $axi_gpio_1
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports pl_leds_2bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports pl_pbs_2bits] [get_bd_intf_pins axi_gpio_1/GPIO]
...
preplace port pl_leds_2bits -pg 1 -lvl 4 -x 1040 -y 80 -defaultsOSRD
preplace port pl_pbs_2bits -pg 1 -lvl 4 -x 1040 -y 220 -defaultsOSRD
